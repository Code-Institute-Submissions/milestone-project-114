...
<head>
    ...
    <title>Coverage for /workspace/.pip-modules/lib/python3.8/site-packages/djstripe/management/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/workspace/.pip-modules/lib/python3.8/site-packages/djstripe/management/__init__.py</b> :
...
<div id="source">
    ...
    <p id="t2" class="pln"><span class="n"><a href="#t2">2</a></span><span class="t"><span class="str">.. module:: djstripe.management.</span>&nbsp;</span><span class="r"></span></p>
    <p id="t3" class="pln"><span class="n"><a href="#t3">3</a></span><span class="t">&nbsp;</span><span class="r"></span></p>
    <p id="t4" class="pln"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="str">   :synopsis: dj-stripe - management module, contains commands.</span>&nbsp;</span><span class="r"></span></p>
